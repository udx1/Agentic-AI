# src/vc_deal_review/agents/compliance_agent.py
from vc_deal_review.agents.base_agent import BaseAgent
from vc_deal_review.schema.compliance import ComplianceReport, ReportResult
...
class ComplianceAgent(BaseAgent):
    def __init__(self, target_max_ask: float = 5_000_000.0, 
        ...
        """
        Initialize the compliance agent with your fund's specific thresholds.
        """
        # Initialize BaseAgent to link Claude setup if needed
        super().__init__()
    ...
    def assess_deal_compliance(self, deal_data: dict) -> ComplianceReport:
        """
        Evaluates incoming extracted deal data against deterministic criteria
        and builds the structured ComplianceReport.
        """
